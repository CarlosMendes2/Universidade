...
public class ServicoBanho extends Servico{
    private String tamanhoPeloAnimal;
    ...
    public ServicoBanho(int codigo, String tamanhoAnimal, String tamanhoPeloAnimal) {
        super(codigo, tamanhoAnimal);
        this.tamanhoPeloAnimal = tamanhoPeloAnimal;
    }
    public Tamanho getTamanhoPeloAnimal() {
        return Tamanho.valueOf(tamanhoPeloAnimal);
    }
    public void setTamanhoPeloAnimal(String tamanhoPeloAnimal) {
        this.tamanhoPeloAnimal = tamanhoPeloAnimal;
    }
    @Override
